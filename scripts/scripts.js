...
// display heart icon button on each product
// when the user click on the wishlist button, add the clicked item to a new location in firebase that contains favourited items
